...
```{mermaid}
---
title: Branching diagram showing Git-based development process with sequential release deliveries
config:
  fontFamily: "IBM Plex Sans"
  gitGraph:
    mainBranchOrder: 3
...
gitGraph
  ...
  merge feature/001
  merge feature/002
  commit tag: "rel2.2-RC1"
  commit
  branch feature/005 order: 5
  commit
  checkout main
  merge feature/005
  commit tag: "rel2.2-RC2"
  commit
```
...
## Survey - Slido {.smaller}

![](static/img/branching-model/slido-snip.png)
